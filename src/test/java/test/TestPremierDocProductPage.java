...
import Pages.PremierDocProductPageReachus;
...
public class TestPremierDocProductPage {
...
//		ChromeOptions options = new ChromeOptions();
	...
	public void testSuccessfulFormSubmission() throws InterruptedException{
		PremierDocProductPageReachus product = new PremierDocProductPageReachus(driver, wait);
		driver.get(url);
