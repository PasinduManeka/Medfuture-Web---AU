...
import Pages.CForceProductPageReachus;
import Pages.ProductPageReachus;
import Pages.SpotProductPageReachus2;
import net.lightbody.bmp.BrowserMobProxy;
import net.lightbody.bmp.BrowserMobProxyServer;
import net.lightbody.bmp.client.ClientUtil;
import net.lightbody.bmp.proxy.CaptureType;

public class TestCForceProductPage {
	
	private static WebDriver driver;
	private static WebDriverWait wait;
	private static BrowserMobProxy proxy;
	private String url = "https://medfuture.com.au/nursing";
...
//		ChromeOptions options = new ChromeOptions();
	...
	public void testSuccessfulFormSubmission() throws InterruptedException{
		CForceProductPageReachus product = new CForceProductPageReachus(driver, wait);
		driver.get(url);
